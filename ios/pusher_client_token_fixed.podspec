...
# Run `pod lib lint pusher_client_token_fixed.podspec' to validate before publishing.
#
require 'yaml'
...
Pod::Spec.new do |s|
  s.name             = 'pusher_client_token_fixed'
  s.version          = libraryVersion
  s.summary          = 'A pusher client plugin.'
  s.description      = <<-DESC
A pusher client plugin that works.
                       DESC
  s.homepage         = 'https://github.com/chinloyal/pusher_client_token_fixed'
